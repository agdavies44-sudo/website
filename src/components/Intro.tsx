...
export default function Intro() {
  ...
  return (
    <section className="flex flex-col items-start gap-4 bg-white px-[2.35%] py-[clamp(22px,3vw,36px)] md:flex-row md:items-center md:justify-between md:gap-6">
      ...
      <p className="m-0 text-[clamp(0.88rem,1.05vw,1.05rem)] leading-[1.2] text-[#444] md:whitespace-nowrap md:text-center">
